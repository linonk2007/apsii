...
public class MinhaAgendaDeAniversarios
        implements AgendaDeAniversarios {
    ...
    public void adicionarAniversariante(
            String nome, int dia, int mes) {

        Aniversariante aniversariante =
                new Aniversariante(nome, dia, mes);

        aniversariantes.add(aniversariante);
    }

    @Override
    public ArrayList<String> obterAniversariantesDoDia(
            int dia, int mes) {

        ArrayList<String> nomes =
                new ArrayList<String>();

        for (Aniversariante aniversariante :
                aniversariantes) {

            DataAniversario data =
                    aniversariante.getDataAniversario();
    ...
    public void removerAniversariante(
        ...
        for (int i = aniversariantes.size() - 1;
                i >= 0; i--) {

            if (aniversariantes.get(i).getNome()
                    .equals(nomeAniversariante)) {
