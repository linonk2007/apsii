...
public interface AgendaDeAniversarios {
    ...
    // retorna uma lista contendo os nomes dos aniversariantes
    // do dia e mês passados como parâmetros
    public ArrayList<String> obterAniversariantesDoDia(int dia, int mes);

    // remove o(s) aniversariante(s) que tenham o nome passado como parâmetro para o método
